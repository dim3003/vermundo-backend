...
public class CreateArticleCommandValidatorTests
{
    ...
    {
        var shortTitle = _faker.Random.String2(2);
    ...
    {
        var shortbody = _faker.Random.String2(49);
    ...
    {
        var command = _factory.Create(_faker.Lorem.Sentence(), _faker.Lorem.Paragraph(3), null);
